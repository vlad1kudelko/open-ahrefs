...
Revision ID: c9a3ef45bd01
Revises:
Create Date: 2025-12-18 09:42:03.910738
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_urls_url_hash"), "urls", ["url_hash"], unique=False)
    op.create_table(
        "links",
